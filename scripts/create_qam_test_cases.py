...
if __name__ == '__main__':
    ...
    data_tumor = sphere((256, 256, 256), 10, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 10, (0, 0, 0))
    data_liver = sphere((256, 256, 256), 10, (0, 0, 0))
    ...
    data_tumor = sphere((256, 256, 256), 5, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 10, (0, 0, 0))
    data_liver = sphere((256, 256, 256), 10, (0, 0, 0))
    # replace everything with False for liver
    data_liver[data_liver == True] = False
    ...
    data_tumor = sphere((256, 256, 256), 10, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 5, (0, 0, 0))
    data_liver = sphere((256, 256, 256), 10, (0, 0, 0))
    # replace everything with False for liver
    data_liver[data_liver == True] = False
    ...
    data_tumor = sphere((256, 256, 256), 5, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 15, (0, 0, 0))
    data_liver = sphere((256, 256, 256), 15, (0, 0, 0))
    # replace everything with False for liver
    data_liver[data_liver == True] = False
    ...
    data_tumor = sphere((256, 256, 256), 10, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 10, (15, 15, 15))
    data_liver = sphere((256, 256, 256), 10, (0, 0, 0))
    # replace everything with False for liver
    data_liver[data_liver == True] = False
    ...
    data_tumor = sphere((256, 256, 256), 10, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 15, (5, 5, 0))
    data_liver = sphere((256, 256, 256), 10, (0, 0, 0))
    # replace everything with False for liver
    data_liver[data_liver == True] = False
    ...
    # shifted z 5mm
    data_tumor = sphere((256, 256, 256), 10, (0, 0, 0))
    data_ablation = sphere((256, 256, 256), 15, (0, 0, 5))
    data_liver = sphere((256, 256, 256), 10, (0, 0, 0))
    # replace everything with False for liver
    data_liver[data_liver == True] = False
